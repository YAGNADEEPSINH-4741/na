  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <head>
        ...
        <script src="https://apis.google.com/js/api.js" onLoad="gapiOnLoad" async defer></script>
        <script src="https://accounts.google.com/gsi/client" onLoad="gsiOnLoad" async defer></script>
